      ...
      <section className="py-16 bg-gray-50" id="noticias">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-[#0a2d8f] mb-2">Noticias y Novedades</h2>
            <p className="text-gray-600">Próximamente tendremos noticias para compartir.</p>
          </div>
        </div>
      </section>
    )
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Mantente informado sobre las actividades, eventos y novedades de nuestra comunidad educativa.
          </p>
        </div>
          ...
          {noticiasRecientes.map((noticia) => (
            <Card key={noticia.id} className="overflow-hidden">
              ...
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-xl text-[#0a2d8f]">{noticia.titulo}</CardTitle>
              </CardHeader>
              <CardContent>
